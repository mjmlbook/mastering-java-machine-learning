...
public class MDSDemo extends JPanel implements Runnable, ActionListener {
    ...
    private static final String[] datasetName = {
        "British Towns", "Euro Cities", "Morse Code", "Color Stimuli", "Lloyds Bank Employees 1905-1909", "Lloyds Bank Employees 1925-1929" , "MNIST"
    };
    ...
    private static final String[] datasource = {
        ...
        "classification/mnist-sample.txt"
    };
        ...
        if ("startButton".equals(e.getActionCommand())) {
            ...
            if (dataset[datasetIndex] == null) {
                ...
                try {
                	if (datasetIndex == 2) {
                    	parser.setColumnNames(true);
                        parser.setResponseIndex(new NominalAttribute("class"), 784);
                    }
